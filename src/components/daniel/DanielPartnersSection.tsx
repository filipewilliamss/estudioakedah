  ...
  return (
    <section id="patrocinadores" className="py-[96px] px-[24px] max-w-[1280px] mx-auto border-t border-white/[0.08] font-lato">
      <div className="text-left mb-[64px]">
        <span className="text-white/60 text-fluid-10 font-bold uppercase tracking-[0.4em] mb-[16px] block">
          Alianças & Parcerias
        </span>
        <h2 className="display text-fluid-44 text-white">
          Patrocinadores & <span className="text-white/80 italic font-light">Marcas Parceiras</span>
        </h2>
        <p className="text-white/60 text-fluid-16 max-w-[68ch] mt-[16px] leading-relaxed font-light">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-[24px] text-left">
        <div className="p-[32px] bg-[#1f1f1f]/90 border border-white/10 hover:border-white/30 rounded-[24px] backdrop-blur-md flex flex-col justify-between min-h-[240px] transition-all">
          <div>
            ...
            <span className="text-white/50 text-fluid-10 uppercase tracking-widest block mb-[8px] font-bold">
              Keynote / Palestras
            </span>
            <h3 className="font-lato text-fluid-20 font-black text-white mb-[8px]">
              Convenções Corporativas
            </h3>
            <p className="text-white/60 text-fluid-13 leading-relaxed font-light">
          ...
          <a
            ...
            className="text-white text-fluid-13 font-bold uppercase tracking-wider hover:underline mt-[24px] inline-block"
          >
            Consultar Agenda →
          </a>
        </div>
