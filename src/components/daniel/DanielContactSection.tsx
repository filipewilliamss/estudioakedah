...
export const DanielContactSection: React.FC = () => {
  return (
    <section id="contato" className="py-28 px-6 border-t border-white/[0.08] font-lato">
      <div className="max-w-7xl mx-auto bg-gradient-to-b from-[#222222] to-[#191919] border border-white/15 rounded-[36px] p-10 sm:p-16 md:p-20 relative overflow-hidden shadow-2xl">
        {/* Glow sutil neutro de fundo */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-white/5 rounded-full filter blur-[100px] pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-12 text-left">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-4 w-full lg:w-auto">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-white text-[#191919] hover:bg-transparent hover:text-white border border-white font-lato font-bold text-xs uppercase tracking-[0.2em] px-10 py-5 rounded-[16px] transition-all shadow-xl hover:scale-105"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-white/10 hover:bg-white/20 text-white border border-white/20 font-lato font-bold text-xs uppercase tracking-[0.2em] px-10 py-5 rounded-[16px] transition-all"
            >
              <Mail className="w-4 h-4" />
              <span>Enviar E-mail Oficial</span>
            </a>

            <p className="text-white/40 text-[11px] font-lato font-light text-center lg:text-left mt-1">
